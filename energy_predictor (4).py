...
# --- 1. CONFGURATION AND CONSTANTS ---
MODEL_PATH ='/content/drive/MyDrive/Energy_shortage_prediction_v01/lgbm_model.pkl'
DATA_PATH ='/content/drive/MyDrive/Energy_shortage_prediction_v01/merged_data_for_app.csv' # <--- FIXED: Now points to your actual data file name
